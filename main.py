...
ตอบ: นักศึกษาปกติลงทะเบียนได้ไม่ต่ำกว่า 9 หน่วยกิต และไม่เกิน 22 หน่วยกิตค่ะ

ถาม: ภาคฤดูร้อน ลงทะเบียนได้กี่หน่วยกิต?
ตอบ: ลงทะเบียนได้ไม่ต่ำกว่า 9 หน่วยกิตค่ะ

ถาม: ถ้าต้องการลงทะเบียนน้อยกว่าเกณฑ์ต้องทำอย่างไร?
ตอบ: ยื่นคำร้องที่ว่าการ ลงนามอาจารย์ที่ปรึกษาค่ะ

ถาม: ลงทะเบียนเพิ่มถอนทำได้ช่วงไหน?
ตอบ: ภายใน 3 สัปดาห์นับตั้งแต่เปิดเทอมค่ะ

ถาม: ค่าลงทะเบียนสำหรับนักศึกษาปกติต้องชำระเท่าไร?
ตอบ: ชำระ 25,000 บาท ต่อภาคการศึกษาค่ะ

ถาม: ค่าลงทะเบียนสำหรับนักศึกษาภาคฤดูร้อนต้องชำระเท่าไร?
ตอบ: ชำระ 5,000 บาท ต่อภาคการศึกษาค่ะ

ถาม: นักศึกษาเรียนมาแล้ว 6 ปีแต่ยังลงทะเบียนไม่ครบ ยังสามารถลงทะเบียนได้ไหม?
ตอบ: ได้ค่ะ 6,000 บาท ต่อภาคการศึกษา

ถาม: ลงทะเบียนเกินกว่าจำนวนหน่วยกิตที่กำหนดสูงสุดได้ไหม?
ตอบ: ทำได้ภายใน 23 หน่วยกิต โดยต้องมีเกรดเฉลี่ยสะสมตั้งแต่ 3.00 ขึ้นไป Reg KMUTNBค่ะ

ถาม: ถ้าเพิ่งเข้าศึกษาและต้องการลงทะเบียนก่อนกำหนดทำได้ไหม?
ตอบ: ตรวจสอบวันลงทะเบียน Reg KMUTNB ตามกำหนดการประจำปีการศึกษาค่ะ

ถาม: ถ้าต้องการลงทะเบียนผ่านระบบออนไลน์ต้องทำอย่างไร?
ตอบ: เข้าไปที่ Reg KMUTNB ที่ reg.kmutnb.ac.thค่ะ

ถาม: ถ้าลงทะเบียนช้าต้องเสียค่าปรับไหม?
ตอบ: ต้องเสียค่าปรับ 1-2 สัปดาห์ค่ะ

ถาม: ถ้าต้องการจบการศึกษาต้องลงทะเบียนวิชาอะไรบ้าง?
ตอบ: ต้องลงทะเบียนครบทุกวิชาตามหลักสูตรรวมถึงวิชา Senior Project หรือ Thesis ตามสาขาที่เรียนค่ะ

ถาม: วิชาเลือกเสรีสามารถลงทะเบียนวิชาจากภาควิชาอื่นได้ไหม?
ตอบ: ได้ค่ะ แต่ต้องตรวจสอบว่าวิชานั้นนับเป็นวิชาเลือกเสรีในหลักสูตรของคุณหรือไม่

ถาม: ถ้าต้องการยกเลิกรายวิชาต้องทำอย่างไร?
ตอบ: ต้องยื่นคำร้องผ่านระบบ Reg KMUTNB ภายในระยะเวลาที่กำหนดค่ะ

ถาม: ถ้าลงทะเบียนผิดพลาดต้องแก้ไขอย่างไร?
ตอบ: ติดต่อสำนักทะเบียนและประมวลผล Reg KMUTNB ตามระยะเวลาที่กำหนดไว้ในปฏิทินการศึกษาค่ะ

ถาม: ภาควิชาอยู่ที่ไหน ที่อยู่คืออะไร?
ตอบ: ภาควิชาครุศาสตร์โยธา คณะครุศาสตร์อุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ อาคาร 52 ชั้น 1 เลขที่ 1518 ถนนประชาราษฎร์ 1 แขวงวงศ์สว่าง เขตบางซื่อ กรุงเทพมหานคร 10800 ค่ะ

ถาม: เบอร์โทรศัพท์ภาควิชาคืออะไร ติดต่อได้ที่ไหน?
ตอบ: โทรศัพท์ 02-555-2000 ต่อ 3247 ค่ะ
"""
...
5. ใช้คำลงท้ายว่า "ค่ะ" ทุกครั้ง ห้ามใช้ "ครับ"
